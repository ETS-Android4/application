...
$univ_field1 = "";
   ...
   $univ_field2 = "GraduateSemester";
        ...
        $result = mysqli_query($conn, "SELECT DISTINCT courseArea FROM COURSE WHERE courseUniversity IN ('$univ_field1', '$univ_field2') AND courseTerm = '$courseTerm' AND c
ourseMajor = '$courseMajor' ORDER BY courseArea");
        $response = array();

        while($row = mysqli_fetch_array($result)) {
                array_push($response, array("courseArea" => $row[0]));
        }
